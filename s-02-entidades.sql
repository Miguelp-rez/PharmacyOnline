...
CREATE TABLE CENTRO_OPERACIONES(
    ...
    CONSTRAINT CEN_OPER_OFICINA_ALMACEN_CHK	 CHECK  ((ES_OFICINA+ ES_ALMACEN)<=1)
    );
--ALMACEN
...
CREATE TABLE PEDIDO(
    ...
    CONSTRAINT PEDIDO_STATUS_ID_FK FOREIGN KEY (STATUS_PEDIDO_ID)
...
CREATE TABLE HISTORICO_STATUS_PEDIDO(
	...
	CONSTRAINT	HISTORICO_SP_STATUS_PEDIDO_ID_FK FOREIGN KEY(STATUS_PEDIDO_ID)
	REFERENCES	STATUS_PEDIDO(STATUS_PEDIDO_ID)
    );
