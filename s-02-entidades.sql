...
CREATE TABLE MEDICAMENTO(
    ...
    CONSTRAINT MEDICAMENTO_ID PRIMARY KEY (MEDICAMENTO_ID)
);
...
CREATE TABLE NOMBRE_MEDICAMENTO(
    ...
    NOMBRE 						VARCHAR2(40)    NOT NULL,
    MEDICAMENTO_ID           	NUMBER(10,0)    NOT NULL,
    CONSTRAINT NOMBRE_MEDICAMENTO_PK PRIMARY KEY (NOMBRES_MEDICAMENTO_ID),
    CONSTRAINT NOMBRE_MEDICAMENTO_ID_FK FOREING KEY(MEDICAMENTO_ID)
...
CREATE TABLE EMPLEADO(
    ...
    NOMBRE                   VARCHAR2(40)     NOT NULL,
    --RFC                  	 VARCHAR2(12)     NOT NULL,
    RFC AS (SUBSTR(CURP,0,10)) VIRTUAL,
...
CREATE TABLE CLIENTE(
   ...
   -- RFC AS (SUBSTR(CURP,0,10)) VIRTUAL,  --COLUMNA VIRTUAL--la quite de aqui porque era nula
    RFC                 VARCHAR2(12),
